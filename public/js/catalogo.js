...
let CATEGORY = 'procesadores';
let API_BASE = '/api/components/procesadores';
let CATEGORY_NAME = 'Componentes';
...
const CATEGORY_MAP = {
  ...
  'coolers': 'Coolers y Enfriamiento',
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  if (catParam && CATEGORY_MAP[catParam]) {
    CATEGORY = catParam;
    API_BASE = `/api/components/${catParam}`;
    CATEGORY_NAME = CATEGORY_MAP[catParam];
  } else {
    // Default fallback
    CATEGORY = 'procesadores';
    API_BASE = `/api/components/procesadores`;
...
function renderCatalogPage(products) {
  ...
  const placeholderBase64 = 'data:image/svg+xml;base64,';
...
function updateSliderVisuals() {
  ...
  const maxPercent = range === 100 ? 100 : ((maxPrice - minPriceLimit) / range) * 100;
